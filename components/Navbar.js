     ...
     <header className=" top-0 left-0 w-full bg-white z-10 px-4 ">
       <div className="flex justify-between items-center container mx-auto">
         ...
         <div className="flex items-center gap-4">
           <svg className='h-5' viewBox="0 0 1176 238" title="Linktree Logo" xmlns="http://www.w3.org/2000/svg">
         ...
         <nav
           ...
           } bg-white w-[80vw] absolute top-14 right-5 md:rounded-full px-5 py-4 md:static md:flex md:flex-row md:justify-between md:items-center md:gap-4`}
         >
